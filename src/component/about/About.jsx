      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 md:pl-4">
          <p className="text-lg leading-relaxed mb-4">
            ...
            adipiscing elit. Curabitur quis leo vel sem feugiat sagittis. Duis
            at ligula vitae justo interdum lacinia. Nulla facilisi. Integer
            auctor, augue vitae cursus mollis, elit eros scelerisque purus, a
            facilisis orci sem sit amet lectus.
          </p>
          ...
          <p className="text-lg leading-relaxed mb-4">
            ...
            adipiscing elit. Vestibulum vel lorem at justo varius gravida non in
