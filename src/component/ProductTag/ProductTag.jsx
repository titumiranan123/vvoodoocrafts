        ...
        <div>
            <section className="products_tags mt-20">
                ...
                <div className="product_tag_container text-sm">
                    ...
                    <button className="py-2 px-2 border ms-2 mt-2 hover:bg-[#44484F] hover:text-white transition-all duration-300">Makeup Bag</button>
                    <button className="py-2 px-2 border ms-2 mt-2 hover:bg-[#44484F] hover:text-white transition-all duration-300">Men</button>
                    <button className="py-2 px-2 border ms-2 mt-2 hover:bg-[#44484F] hover:text-white transition-all duration-300">Mini Backpack</button>
                    <button className="py-2 px-2 border ms-2 mt-2 hover:bg-[#44484F] hover:text-white transition-all duration-300">Minibag</button>
                    <button className="py-2 px-2 border ms-2 mt-2 hover:bg-[#44484F] hover:text-white transition-all duration-300">Minimal </button>
                    <button className="py-2 px-2 border ms-2 mt-2 hover:bg-[#44484F] hover:text-white transition-all duration-300">Molding </button>
                    <button className="py-2 px-2 border ms-2 mt-2 hover:bg-[#44484F] hover:text-white transition-all duration-300">Pencil Bag </button>
                    <button className="py-2 px-2 border ms-2 mt-2 hover:bg-[#44484F] hover:text-white transition-all duration-300">Pipe Smoking Accessory</button>
                    <button className="py-2 px-2 border ms-2 mt-2 hover:bg-[#44484F] hover:text-white transition-all duration-300">Pouch </button>
                    <button className="py-2 px-2 border ms-2 mt-2 hover:bg-[#44484F] hover:text-white transition-all duration-300">Remote</button>
                    <button className="py-2 px-2 border ms-2 mt-2 hover:bg-[#44484F] hover:text-white transition-all duration-300">Unisex</button>
                    <button className="py-2 px-2 border ms-2 mt-2 hover:bg-[#44484F] hover:text-white transition-all duration-300">Waist Bags </button>
                    <button className="py-2 px-2 border ms-2 mt-2 hover:bg-[#44484F] hover:text-white transition-all duration-300">Wear Around Neck </button>
                    <button className="py-2 px-2 border ms-2 mt-2 hover:bg-[#44484F] hover:text-white transition-all duration-300">Women</button>
                    <button className="py-2 px-2 border ms-2 mt-2 hover:bg-[#44484F] hover:text-white transition-all duration-300">Zipper Pouch</button>
                </div>
