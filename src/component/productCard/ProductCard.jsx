    ...
    <div>
      <div className="relative m-10  flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-[#C94428] bg-white shadow-md">
        ...
        >
          ...
          <span className="absolute top-0 left-0 m-2 rounded-full bg-[#C94428] px-2 text-center text-sm font-medium text-white">
            39% OFF
          </span>
        </a>
        <div className="mt-4 px-5 pb-5">
          ...
          <button
            onClick={() => handalClick(product)}
            className="flex items-center justify-center rounded-md bg-[#C94428] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#C94428] hover:bg-opacity-90 focus:outline-none focus:ring-4 focus:ring-blue-300"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
