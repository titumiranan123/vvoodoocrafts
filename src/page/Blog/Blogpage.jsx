...
const blog = [
  ...
  },
  {
    ...
    description:
      "Discover how to create responsive web applications using React and modern design principles.",
    userId: "user3",
  ...
  },
  {
    ...
    description:
      "Get started with Node.js and build scalable and efficient server-side applications.",
    userId: "user4",
  ...
  },
  {
    ...
    description:
      "Explore the new features introduced in ECMAScript 2015 (ES6) and enhance your JavaScript skills.",
    userId: "user5",
  ...
  },
  {
    ...
    description:
      "Learn the fundamentals of Vue.js and build interactive user interfaces with ease.",
    userId: "user6",
  ...
  },
  {
    ...
    description:
      "A quick and comprehensive guide to getting started with Django for web development using Python.",
    userId: "user7",
  ...
  },
  {
    ...
    description:
      "Explore the benefits of using GraphQL for building efficient and flexible APIs.",
    userId: "user8",
