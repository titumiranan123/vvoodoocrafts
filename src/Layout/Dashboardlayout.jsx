  ...
  <div className=" bg-opacity-60 h-screen">
    <ul className="space-y-2 font-medium border-b-2 border-[#C94428] py-4">
      <li>
        <a
          href="/dashboard"
          className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-[#C94428] hover:text-white dark:hover:bg-gray-700 group"
        >
    ...
    <ul className="pt-4 mt-4 space-y-2 font-medium  dark:border-gray-700">
      ...
      <li>
        <a
          href="#"
          className="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-[#C94428] hover:text-white dark:hover:bg-gray-700 dark:text-white group"
        >
    ...
    <div className="lg:max-w-[1540px]  px-4  mx-auto ">
      <div className="flex justify-between z-50 pt-6 p-2 bg-white w-[1540px] box-border fixed top-0  items-center">
        ...
        <div>
          <img
            src={user}
            className="w-12 h-12 rounded-full bg-red-500 p-2"
            alt=""
          />
        </div>
      </div>
      <div className="flex gap-10 mt-20 ">
        <div className="  w-[20%]  h-screen mt-25 ">{navItem}</div>
